...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, Observer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( model.isLoggedIn()){
            Intent intent = new Intent(this, ProgressNavigationActivity.class);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if (register) {
                model.createUser(mEmail, mPassword);
            } else{
                model.setEmailAndPassword(mEmail, mPassword);
    ...
    public void update(Observable o, Object data){
        ...
        try {
            success = jdata.getBoolean("success");
        ...
        if (success) {
            ...
            int code = 0;
            try {
                code = jdata.getInt("errorCode");
            } catch (JSONException e) {
                e.printStackTrace();
            }

            if(code==FirebaseError.USER_DOES_NOT_EXIST){
                mEmailView.setError(getString(R.string.error_user_did_not_exist));
                ...
                try {
                    mEmailView.setError(jdata.getString("errorMessage"));
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
